...
const getSudoku = createSelector(state => state.sudoku, sudoku => sudoku.sudoku);
const getIsFetching = createSelector(state => state.sudoku.fetching, fetching => fetching);
const getHasErrors = createSelector(state => state.sudoku.error, error => error);
...
export const Board = () => {
    ...
    const getStatusMessage = () => {
        ...
        return <div style={styles.loadingText}>Calculating, please wait...</div>
            ...
            return <div style={styles.errorText}>Could not solve this one.. You probably have many faulty numbers :(</div>
        }
